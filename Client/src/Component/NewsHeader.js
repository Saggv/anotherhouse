            ...
            <div className="newsheader">
                <div className="newsheader-box">
                    <div className="newsheader-box__user">
                        {
                            user.avatar ? (
                                <img src={user.avatar} alt="loadding.." onClick={()=>ClosePost()} />
                            ): null
                        }
                    </div>
                    <div className="newsheader-box__input-box">
                        {
                            openPost ?(
                                <div className="newsheader-box__post">
                                    <input className="newsheader-box__post__input" onChange={(e)=>setTitle(e.target.value)}  type="text" placeholder="Title of the post..."/>
                                </div>
                            ):null
                        }
                         <textarea onClick={()=>ClickOpenPost()} onChange={(e)=>setContent(e.target.value)} value={content}  placeholder="Write something here...">
                         </textarea>
                         <br/>
                        {
                            openPost ? (
                                <div className="newsheader-box__privew">
                                    { 
                                        ...
                                        return(
                                                <img src={item} key={index} alt="upload fiel..." onClick={()=>RemovePrivewImg(index)}></img>
                                            )
                                        })):null
                                    }
                        ...
                        {
                            openPost ? (
                                <button type="submit" onClick={()=>SubmitNewsfeed()} className="btn btn-submit display-block">Submit</button>
                            ):null
                        }
                    </div>
                </div>
